  ...
  return {
    ...
    async Once(css, {
      ...
      css.walkAtRules(/^import$/i, rule => {
        ...
        const [urlNode] = valueParser__default["default"](rule.params).nodes;
        // No URL detected
      ...
      for await (const {
        ...
        try {
          ...
          const imported = await postcss__default["default"](plugin$3(options)).process(source, {
            ...opts,
            from
          });
    ...
    async Once(css, {
      ...
      css.walkDecls(decl => {
        ...
        walkUrls(parsed, (url, node) => {
          ...
          // Use PostCSS imports
          if ((_decl$source = decl.source) !== null && _decl$source !== void 0 && _decl$source.input.file && imported.includes(decl.source.input.file)) basedirs.add(path__default["default"].dirname(decl.source.input.file));
          // Use SourceMap
